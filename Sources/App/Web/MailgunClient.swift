...
func optionsForTransportationsEmail(baseURL: String) -> EmailBody {
    ...
    html += "<div style='text-align:center; padding-bottom: 40px;'><font size='6' color='#ff0000'><b style='background-color:rgb(255,255,0)'>PLEASE DISREGARD THIS EMAIL IF YOU ARE NOT PARTICIPATING FOR THE POST-CONGRESS TRIP TO REDANG ISLAND</b></font></div>"
