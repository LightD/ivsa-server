angular.module('ivsaAdmin').controller('RejectedController', function WaitlistController($scope, $http, $window, $filter, modalService) {
	  ...
	  $scope.setup = function(token) {
	     ...
	     $http.get("/api/admin/delegates/confirmedRejected", { headers: { "Authorization": "Bearer " +  token} })
