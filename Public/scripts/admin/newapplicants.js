angular.module('ivsaAdmin').controller('NewApplicantsController', function NewApplicantsController($scope, $http, $window, $filter, modalService) {
       ...
       $scope.setup = function(token) {
           ...
           $http.get("/api/admin/delegates/newApplicant", { headers: { "Authorization": "Bearer " +  token} })
